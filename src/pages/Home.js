  ...
  return (
    <>
      ...
      <div className="topBanner">
        ...
        <div className="tabs">
          ...
          <div>
            ...
            <a href="/homestayes"><em style={{color:"black", textDecoration:"none"}}>Home Stayes</em></a>          
          </div>
          <div>
            <em>Flights</em>
          </div>
      ...
      <div className="main-container">
        <h2>Welcome to Decentralized Realm, a 100% Web3 Enabled Website</h2>
